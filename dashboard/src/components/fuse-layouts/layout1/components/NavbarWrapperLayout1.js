...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        navbarOpenFolded : FuseActions.navbarOpenFolded,
        navbarCloseFolded: FuseActions.navbarCloseFolded,
        navbarCloseMobile: FuseActions.navbarCloseMobile
    }, dispatch);
}
...
function mapStateToProps({FuseReducer})
{
    return {
        ...
        navbarTheme: FuseReducer.settings.navbarTheme,
        navbar     : FuseReducer.navbar
    }
}
