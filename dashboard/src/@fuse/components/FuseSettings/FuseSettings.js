...
import {withStyles, Typography, FormControl,  FormLabel, MenuItem,  Select} from '@material-ui/core';
...
class FuseSettings extends Component {
    ...
    render()
    {
        ...
        console.log("FuseSettings themes - ", themes);
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        setDefaultSettings: actions.FuseActions.setDefaultSettings,
        updateUserSettings: actions.AuthActions.updateUserSettings
    }, dispatch);
}

function mapStateToProps({FuseReducer, AuthReducer})
{
    return {
        settings: FuseReducer.settings.current,
        themes  : FuseReducer.settings.themes,
