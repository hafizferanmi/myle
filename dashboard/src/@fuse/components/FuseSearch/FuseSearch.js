            ...
            {variant === "basic" ? (
                    ...
                    <React.Fragment>
                        <TextField
                            ...
                            {...other}
                        />
                        <Icon className="absolute pin-t pin-r h-40 w-40 p-8 pointer-events-none" color="action">search</Icon>
                    </React.Fragment>
                )
                :
                (
...
{
    return {
        navigation: FuseReducer.navigation,
        userRole  : AuthReducer.user.role
    }
}
